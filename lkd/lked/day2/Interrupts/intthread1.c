...
{
    if (request_threaded_irq(irq, my_interrupt, my_thread, IRQF_SHARED, "my_interrupt", &my_dev_id))
        return -1;
...
static void __exit my_exit (void)
{
    ...
    pr_info (KERN_INFO "Successfully unloading \n");
}
